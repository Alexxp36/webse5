                ...
                <div class="card-body">
                    <form action="cController">
                        <div class="input-group mt-2">
                            ...
                            <input class="form-control" type="text" name="txtCodigo" id="pencil1" placeholder="Código"
                                   autofocus required>
                        </div>

                        <div class="input-group mt-2">
                            <label class="input-group-text">Nombre</label>
                            <input class="form-control" type="text" name="txtNombre" id="pencil1" placeholder="Nombre"
                                   required>
                        </div>

                        <div class="input-group mt-2">
                            <label class="input-group-text">Créditos</label>
                            <input class="form-control" type="text" name="txtCreditos" id="pencil1"
